...
export const menus: MenuItem[] = [
  ...
  // ============================================
  {
    ...
    subMenus: [
      ...
      // Engine Branches
      {
        ...
        path: "/configuration/engine-branches",
        label: "Engine Branches",
        icon: "fa fa-sitemap",
        roles: [
          [{ code: "ROLE_ADMIN" }],
          [{ code: "ROLE_MANAGER" }],
      ...
      // Formulaires
      {
        ...
        roles: [[{ code: "ROLE_ADMIN" }], [{ code: "ROLE_MANAGER" }]],
      },
      // Types de données
      {
  ...
  // ============================================
  {
    ...
    roles: [[{ code: "ROLE_COMMERCIAL" }], [{ code: "ROLE_MANAGER" }]],
    subMenus: [
      {
        name: "crm-contacts",
        path: "/crm/contacts",
  ...
  // ============================================
  {
    ...
    roles: [[{ code: "ROLE_ADMIN" }], [{ code: "ROLE_COMPTABLE" }]],
    subMenus: [
      {
